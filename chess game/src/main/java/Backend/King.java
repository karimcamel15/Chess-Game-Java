        ...
        if (absDeltaY == 0) {
            if (move.getDeltaX() == 2) {
                ...
                if (getOwner() == Player.WHITE && game.isCanWhiteCastleKingSide()) {
                    ...
                    if (move.getFromSquare().equals(new Square(BoardFile.E, BoardRank.FIRST))
                            && move.getToSquare().equals(new Square(BoardFile.G, BoardRank.FIRST))) {
                    ...
                    if (move.getFromSquare().equals(new Square(BoardFile.E, BoardRank.EIGHTH))
                            && move.getToSquare().equals(new Square(BoardFile.G, BoardRank.EIGHTH))) {
                ...
                if (getOwner() == Player.WHITE && game.isCanWhiteCastleQueenSide()) {
                    ...
                    if (move.getFromSquare().equals(new Square(BoardFile.E, BoardRank.FIRST))
                            && move.getToSquare().equals(new Square(BoardFile.C, BoardRank.FIRST))) {
                        throw new RuntimeException("Castle can't be valid from square different than E1");
                    }
                    return true;
