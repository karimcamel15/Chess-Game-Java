...
public abstract class ChessGame {
    ...
    protected Stack<ChessGameMemento> undoStack = new Stack<>();
    ...
    public boolean makeMove(Move move) {
        ...
        ChessGameCaretaker careTaker = new ChessGameCaretaker(this);
        ...
        if (fromPiece instanceof Pawn) {
            ...
            if (toSquareRank == BoardRank.FIRST || toSquareRank == BoardRank.EIGHTH) {
                Player playerPromoting = toSquareRank == BoardRank.EIGHTH ? Player.BLACK : Player.WHITE;
    ...
    protected static class ChessGameMemento {
        ...
        public ChessGameMemento(ChessGame chessGame) {
            this.board = new ChessBoard(chessGame.board);
            this.whoseTurn = chessGame.getWhoseTurn();
            this.canWhiteCastleKingSide = chessGame.canWhiteCastleKingSide;
            this.canWhiteCastleQueenSide = chessGame.canWhiteCastleQueenSide;
            this.canBlackCastleKingSide = chessGame.canBlackCastleKingSide;
            this.canBlackCastleQueenSide = chessGame.canBlackCastleQueenSide;
        }
        ...
        private boolean isCanWhiteCastleKingSide() {
            return canWhiteCastleKingSide;
        }

        private boolean isCanWhiteCastleQueenSide() {
            return canWhiteCastleQueenSide;
        }

        private boolean isCanBlackCastleKingSide() {
            return canBlackCastleKingSide;
        }

        private boolean isCanBlackCastleQueenSide() {
            return canBlackCastleQueenSide;
        }
    }

    protected void restoreBoardAfterUndo(ChessGameMemento memento) {
